...
| **Space for optimization?** | Yes — ranked in `03-optimization-levers.md`. Spec length stays **K5** (REAP-validated; per-position acceptance decays pos0→pos4, so 7/9 add little). Next: **4 small already-upstream attention/indexer patches** (`#52823`, `#51967`, `#52084`, `#50911`). |
