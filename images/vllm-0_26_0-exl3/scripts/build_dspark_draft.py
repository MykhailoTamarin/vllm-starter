...
Ported from the 0xSero `deepseek-v4-flash-0731-spark-sparkinfer` recipe
(scripts/build_dspark_draft.py) unchanged -- it matches this checkpoint's
contract exactly (3 MTP stages x 216 current experts, sorted ``mtp_keep``,
REAP plan with ``structured_ranked_by_category``).
