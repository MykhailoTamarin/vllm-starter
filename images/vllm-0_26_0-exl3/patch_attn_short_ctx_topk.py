...
H3_NEW = (
    ...
    "            # [PORT #52492] Never take the shortcut during CUDA graph capture:\n"
    "            # a captured graph replays it against longer cached prefixes (>2048\n"
    "            # tokens) and returns candidates 0..topk-1 unscored.\n"
    "            if (\n"
