...
| ------------------------------------------- | ----------- | ---------- | ------- | --------------: | -------------- | ---------------------------------------- | -------------- | ------------ |
| **qwen3.6-35b-a3b-nvfp4-mtp** | 35B / 3B | 21.9G | 256k | 13.65x | 1.7–6.1k t/s | 81–134 t/s (C1), 129–247 t/s (C2: ~296 @ 2k, ~207 @ 4k, ~69 @ 8k; C4: ~345 @ d0, ~214 @ 1k, ~116 @ 2k) | 17.2s | ✅ **Tested** |
| **qwen3.6-35b-a3b-nvfp4-mtp-yarn** | 35B / 3B | 21.9G | 1M | 7.19x | 1.0–5.9k t/s | 35–235 t/s | 17.2s | ✅ **Tested**  |
