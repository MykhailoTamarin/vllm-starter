...
./llama-bench.sh --model qwopus3.6-27b-v2-nvfp4-mtp --depth 0 4096 8192 16384 32768 65536 131072 --latency-mode generation

# Explicit model via YAML config name and concurrency test — compare single vs multi-client throughput
./llama-bench.sh --model qwopus3.6-27b-v2-nvfp4-mtp --depth 0 4096 8192 16384 32768 65536 --concurrency 1 2 4 --latency-mode generation
```
