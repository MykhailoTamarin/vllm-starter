...
| ---------------------------------------- | ---------------- | ---------- | ---------- | ---------- | ------- | -----------: | ----------------------------------------: | ---------: | ----------------------------------------------------------------------------- |
| **gpt-oss-120b**                          | MXFP4            | 117B / 5.1B | —     | flashinfer | 256k    |            — |                                         — |          — | ⬜ Untested                                                                    |
...
| **qwen3.6-27b-nvfp4-mtp**                | NVFP4 (modelopt) | 27B (dense) | 18.9G | flashinfer+MTP | 256k    | 1.1–2.2k t/s | 18–30 t/s (C8: 13 @ 8k, ~170 t/s total) |      59.2s | ✅ **Tested**                                                                  |
